#pet = dictionary {"type of animal": {"name of animal": "color", "name of animal2": "color"}, "type of animal"... }
...
length = len(pets["dogs"])
for eachPet in range(0, length):
    #print(pets["dogs"][eachPet])
    print(pets["dogs"][eachPet])
    print()
    #print(eachPet) #0 then #1
